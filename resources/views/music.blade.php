...
<div class="container">
    <div class="p-4 p-md-5 mb-4 text-white border rounded bg-dark ">
        <div class="col p-4 d-flex flex-column position-static">
            ...
            <h1 class="display-4 fst-italic">Riot Games выпустила альбом из 37 треков для свободного использования на YouTube, Twitch и других площадках</h1>
            <p class="lead my-3">Сборник под названием Sessions: Vi станет лишь первым из нескольких. Riot обещает выпустить второй альбом из серии до конца 2021 года.</p>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <h3 class="mb-0">Soulmates Never Die: история группы Placebo</h3>
                    <div class="mb-1 text-muted">15.07</div>
                    <p class="card-text mb-auto">Как перерасти эпатаж и сохранить аутентичность.</p>
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-success">Музыка</strong>
                    <h3 class="mb-0">Музыкальные релизы недели: второй альбом Билли Айлиш, новый EP Creeper, камбэк-альбом Chunk! No, Captain Chunk!</h3>
                    <div class="mb-1 text-muted">20.07</div>
                    <p class="mb-auto">И даже немного Мадонны.</p>
                    <a href="#" class="stretched-link">Подробнее</a>
                </div>
                <div class="col-auto d-none d-lg-block">
