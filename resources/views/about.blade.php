...
<main class="container">
    <div class="p-4 p-md-5 mb-4 text-white border rounded bg-dark">
        <div class="col-md-6 px-0">
            <h1 class="display-4 fst-italic">Страница про нас!</h1>
            <p class="lead my-3">text example</p>text example</p>text example</p>
            <p class="lead my-3">Вы можете связаться с нами по номеру телефона +7 000 000-00-00</p>
            <p class="lead my-3">...или написать на почту: test@example.com</p>
        </div>
    </div>
