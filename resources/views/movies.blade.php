...
<div class="container">
    <div class="p-4 p-md-5 mb-4 text-white border rounded bg-dark ">
        <div class="col p-4 d-flex flex-column position-static">
            ...
            <h1 class="display-4 fst-italic">Видения Пола Атрейдеса и война двух домов во втором полноценном трейлере «Дюны»</h1>
            <p class="lead my-3">Фильм планируют выпустить в российский прокат 14 октября.</p>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <h3 class="mb-0">Режиссёры-монстры: что творится на съёмочных площадках у известных постановщиков</h3>
                    <div class="mb-1 text-muted">15.07</div>
                    <p class="card-text mb-auto">Эксперименты Финчера, жестокость Полански и перфекционизм Кубрика.</p>
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-primary">Кино</strong>
                    <h3 class="mb-0">Второй сезон «Ведьмака» выйдет на Netflix 17 декабря — тизер-трейлер и подробности</h3>
                    <div class="mb-1 text-muted">20.07</div>
                    <p class="mb-auto">Дату выхода объявили на WitcherCon — с названиями эпизодов и кадрами из них.</p>
                    <a href="#" class="stretched-link">Подробнее</a>
                </div>
                <div class="col-auto d-none d-lg-block">
